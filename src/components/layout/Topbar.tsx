...
export const Topbar = ({ onMenuClick }: TopbarProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between border-b border-border bg-background/95 backdrop-blur-sm px-4 py-3 md:px-6 md:py-4">
